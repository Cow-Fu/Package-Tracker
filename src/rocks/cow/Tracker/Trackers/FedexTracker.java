...
public final class FedexTracker implements Tracker {
    ...
    private WebPageHandler webHandler = new WebPageHandler() {
        @Override
        public WebDriver loadPageSource(WebDriver webDriver) {
            ...
            ((HtmlUnitDriver) webDriver).executeScript(javascript);
    ...
    public HashMap<String, ArrayList<? extends String>> track(Package p) {
        webHandler.setDriver(new HtmlUnitDriver() {
            @Override
